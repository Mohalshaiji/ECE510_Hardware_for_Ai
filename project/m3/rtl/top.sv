...
//   s_axis_tdata   input  512b   UCIe flit from host (error map words)
//   s_axis_tvalid  input   1b    AXI-S valid
//   s_axis_tready  output  1b    AXI-S ready
//   s_axis_tlast   input   1b    last flit of input vector
//   s_axis_tkeep   input  64b    byte enable (all-ones for FP32)
//   m_axis_tdata   output 512b   UCIe flit to host (feedback map words)
...
//                                (128 nodes x 32b; settling characterised by
//                                 ngspice: tau_128=50.8ps, t99=257ps < 10ns CLK)
//   sample_pulse   output  1b    trigger to analog crossbar
//
// Glue wires:
//   e_in_w      N_IN*32 bits   interface_mod -> compute_core
//   fb_out_w    N_OUT*32 bits  compute_core  -> interface_mod
//   core_start  1b             interface_mod -> compute_core (start pulse)
//   core_done   1b             compute_core  -> interface_mod (done pulse)
// =============================================================================
